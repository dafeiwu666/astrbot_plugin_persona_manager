    ...
    async def resolve_persona_for_inject_for_context(
        ...
        return PersonaResolutionResult(
            persona=ResolvedPersona(
                ...
                wrapper_use_config=getattr(p, "wrapper_use_config", True),
                wrapper_prefix=getattr(p, "wrapper_prefix", ""),
                wrapper_suffix=getattr(p, "wrapper_suffix", ""),
                clean_use_config=getattr(p, "clean_use_config", False),
                clean_regex=getattr(p, "clean_regex", ""),
